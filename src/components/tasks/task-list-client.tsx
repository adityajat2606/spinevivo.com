...
export function TaskListClient({ task, initialPosts, category }: Props) {
  ...
  if (!merged.length) {
    return (
      <div className="rounded-[2rem] border border-dashed border-black/10 bg-[linear-gradient(180deg,rgba(248,250,252,0.9),rgba(255,255,255,0.95))] px-8 py-16 text-center">
        <p className="text-lg font-semibold text-[#0a0a0a]">No listings in this view yet</p>
        <p className="mt-2 text-sm text-[#525252]">Try another category or check back as new businesses go live.</p>
      </div>
    );
  }
